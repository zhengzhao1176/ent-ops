...
// .wrangler/tmp/bundle-7G5iYR/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-0Jfpl1/bundledWorker-0.3558443496754007.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, n, a) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let r of re(t))
      !oe.call(e, r) && r !== n && U(e, r, { get: () => t[r], enumerable: !(a = se(t, r)) || a.enumerable });
  return e;
}, "ce");
var F = /* @__PURE__ */ __name2((e, t, n) => (n = e != null ? ne(ie(e)) : {}, ce(t || !e || !e.__esModule ? U(n, "default", { value: e, enumerable: true }) : n, e)), "F");
var f;
var u = M(() => {
  f = { collectedLocales: [] };
});
  ...
  function Re(e, t) {
    ...
    for (var n = {}, a = t || {}, r = a.decode || Se, i = 0; i < e.length; ) {
      ...
      if (n[c] === void 0) {
        ...
        l.charCodeAt(0) === 34 && (l = l.slice(1, -1)), n[c] = ke(l, r);
      }
      i = o + 1;
    }
    return n;
...
__name(H, "H");
__name2(H, "H");
async function P(e, { request: t, assetsFetcher: n, ctx: a }, { path: r, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        s = S(await n.fetch(L(c, e.path ?? r))), e.headers && m(s.headers, e.headers);
        break;
      }
      case "static": {
        s = await n.fetch(L(c, r));
        break;
      }
      default:
...
__name(he, "he");
__name2(he, "he");
async function W(e, { buildOutput: t, assetsFetcher: n, imagesConfig: a }) {
  let r = pe(e, a);
  if (!r)
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = z(e, fe), s = await a.get(r, { softTags: i });
      ...
      case "POST": {
        let i = globalThis[ge], s = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
          o.data.tags === void 0 && (o.tags ??= z(e, ye) ?? []), await a.set(r, o);
        }, "s");
...
__name2(z, "z");
function Z() {
  globalThis[X] || (ve(), globalThis[X] = true);
}
__name(Z, "Z");
__name2(Z, "Z");
function ve() {
...
async function xe(e) {
  if (e.url.startsWith("blob:"))
    try {
      let n = `./__next-on-pages-dist__/assets/${new URL(e.url).pathname}.bin`, a = (await k(n)).default, r = { async arrayBuffer() {
        return a;
      }, get body() {
...
var E = /* @__PURE__ */ __name2(class {
  ...
  async runRouteMiddleware(t) {
    ...
    let a = await P(n, this.reqCtx, { path: this.path, searchParams: this.searchParams, headers: this.headers, status: this.status });
  ...
  applyLocaleRedirects(t) {
    if (!t.locale?.redirect || !/^\^(.)*$/.test(t.src) && t.src !== this.path || this.headers.normal.has("location"))
      return;
    let { locale: { redirect: a, cookie: r } } = t, i = r && this.cookies[r], s = A(i ?? ""), o = A(this.reqCtx.request.headers.get("accept-language") ?? ""), p = [...s, ...o].map((g) => a[g]).filter(Boolean)[0];
    if (p) {
  ...
  async checkPhase(t) {
    ...
    let r = "miss";
    return a || t === "miss" || t === "error" ? r = "hit" : n && (r = H(t)), this.checkPhase(r);
  }
  async run(t = "none") {
...
async function Ce(e, { path: t = "/404", status: n, headers: a, searchParams: r, body: i }, s) {
  ...
  if (i !== void 0)
    ...
    c = await P(s[t], e, { path: t, status: n, headers: a, searchParams: r });
  let l = a.normal;
...
var Ta = { async fetch(e, t, n) {
  ...
  return r.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: T }, async () => i.run({ env: t, ctx: n, cf: e.cf }, async () => {
    if (new URL(e.url).pathname.startsWith("/_next/image"))
      return W(e, { buildOutput: y, assetsFetcher: t.ASSETS, imagesConfig: h.images });
    let o = B(e);
...
// .wrangler/tmp/pages-0Jfpl1/4j8xwdlgkb.js
...
// .wrangler/tmp/bundle-7G5iYR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-7G5iYR/middleware-loader.entry.ts
