...
- Name: site-walk.admin.spec.ts >> Site-wide walker (clicks + inputs every interactive element) >> probe: goods-list /inv/goods
...
Call log:
  - waiting for locator('select[data-testid]').nth(1)
